...
export default async function Page(): Promise<JSX.Element> {
  ...
  return (
    <>
      <Lenis />
      <div className="bg-[#33CCFC] w-1/6 max-w-screen h-4/6 absolute top-[50%] left-1/2 md:left-[75%] -translate-x-1/2 -translate-y-1/2 rounded-full -rotate-45 blur-[100px] -z-10" />
      <div className="bg-[#FE43EB] w-[10%] max-w-screen h-3/6 absolute top-[60%] left-1/2 md:left-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full rotate-45 blur-[100px] -z-10" />
      <div
